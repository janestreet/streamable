...
Error: This application of the functor Streamable.Stable.V1.Of_tuple3 is ill-typed.
       ...
       1. Modules do not match:
          ...
          File "module_type.ml", line 100, characters 2-36:
            Expected declaration
       2. Module Streamable.Stable.V1.Of_result(Streamable.Stable.V1.Of_atomic(Core.Float))(Streamable.Stable.V1.Of_atomic(Core.Error.Stable.V2)) matches the expected module type Streamable__Main_intf.S
       3. Module Streamable.Stable.V1.Of_map(Core.String)(Streamable.Stable.V1.Of_atomic(Core.Bool)) matches the expected module type Streamable__Main_intf.S
```
