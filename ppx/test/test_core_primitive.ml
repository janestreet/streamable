...
include Test.Is_S_rpc (struct
  ...
  include Streamable.Stable.V1.Remove_t_rpc (Streamable.Stable.V1.Of_atomic_rpc (Core.Bool))
...
include Test.Is_S_rpc (struct
  ...
  include Streamable.Stable.V1.Remove_t_rpc (Streamable.Stable.V1.Of_atomic_rpc (Core.Char))
...
include Test.Is_S_rpc (struct
  ...
  include Streamable.Stable.V1.Remove_t_rpc (Streamable.Stable.V1.Of_atomic_rpc (Core.Int))
...
include Test.Is_S_rpc (struct
  ...
  include
    Streamable.Stable.V1.Remove_t_rpc (Streamable.Stable.V1.Of_atomic_rpc (Core.Nativeint))
...
include Test.Is_S_rpc (struct
  ...
  include Streamable.Stable.V1.Remove_t_rpc (Streamable.Stable.V1.Of_atomic_rpc (Core.Unit))
